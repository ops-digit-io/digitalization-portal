...
function researchSystemPrompt(playbook: string): string {
  return [
    "You are the domain-research agent for the Digital Unit Portal. Research the demand freely against public data and write a research brief. You draft; a human decides. You pass no gate.",
