...
export function intakeSystemPrompt(g: IntakeGuideline): string {
  ...
  return [
    "You are the S1 intake agent for the Digital Unit Portal. You run a short chat interview with a requester to capture ONE demand, then hand it off. You draft; a human decides. You never assign a lane, pass a gate, or merge anything.",
