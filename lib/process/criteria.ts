...
export const CRITERIA: Criterion[] = [
  // ---------------------------------------------------------------- D1
  {
    ...
    evidence: "Artefakt (Diagramm, SOP, Verfahrensanweisung) mit Datum/Versionshistorie; Stichprobe: drei beobachtete Prozessschritte gegen die Darstellung gehalten.",
    scale: [
      ...
      "Versioniertes Artefakt mit benanntem Pflege-Owner und mehreren datierten Änderungen (erkennbarer Pflegerhythmus), Stichprobe konsistent.",
    ],
  },
  {
    ...
    evidence: "Doku enthält je Schritt Rolle, Tool, Input, Output; Test: eine prozessfremde Person beschreibt den Ablauf nur aus der Doku, der Owner korrigiert.",
    scale: [
      "Doku (falls vorhanden) nennt nur Schrittnamen; weder Rollen noch Tools noch In-/Outputs.",
      "Rollen ODER Tools je Schritt benannt, nicht beides; In-/Outputs fehlen.",
      "Rolle, Tool, In-/Output je Schritt für den Hauptpfad vorhanden; der Test scheitert an Sonderfällen.",
      "Der Test gelingt für den Hauptpfad ohne mündliche Nachhilfe.",
      "Der Test gelingt inklusive der häufigsten Sonderfälle; Eskalationswege sind beschrieben.",
    ],
  },
  {
  ...
  },
  {
    ...
    scale: [
      "Kein technischer Zugang und kein benennbarer Freigabeweg (geschlossenes System, Anbieter-Blackbox, verwaiste Berechtigungen).",
      "Zugang theoretisch möglich (Anbieter, Konzern-IT), aber kein Präzedenzfall und Freigabeweg ungeklärt.",
  ...
  },
  {
    ...
    evidence: "Benanntes führendes System je Kerndatum; Zählung paralleler Pflegeorte für dieselben Daten (Listen, lokale Kopien).",
    scale: [
      ...
      "Ein führendes System, keine parallel gepflegten Kopien; Änderungen dort sind für alle Konsumenten sichtbar.",
    ],
  },
  ...
  // ---------------------------------------------------------------- D3
  {
    ...
    evidence: "Datenauszug mit Zeitstempeln (Ticketsystem, Logs, Workflow-Tool, Mail-Header); Konfidenzstufe P oder I — Stufe S zählt hier als Schätzung.",
    scale: [
  ...
  },
  {
    ...
    evidence: "Timestamp-Zerlegung in Warte- und Aktivzeit; die drei größten Liegestellen mit Zahlen belegt (Latenzprofil, B Phase 2).",
    scale: [
  ...
  },
  {
    ...
    scale: [
      ...
      "Klassifizierung liegt vor UND wertfreie Übergaben wurden nachweislich schon entfernt oder zusammengelegt.",
    ],
  },
  {
    id: "K3.4", dimension: "D3", label: "Parallelisierungs- und Kill-Kandidaten",
    question: "Welche Schritte könnten gleichzeitig laufen? Und welcher Schritt könnte ersatzlos entfallen, ohne dass es jemand merkt?",
    evidence: "Schrittliste mit Abhängigkeitsbegründung; Schritte, deren Output nachweislich niemand konsumiert (Verteilerprüfung, Lese-/Zugriffsstatistik) — Input für Zweig 0 (B §4).",
    scale: [
      "Abhängigkeiten zwischen Schritten kann niemand begründen; die Reihenfolge ist „schon immer so“.",
      ...
      "Zusätzlich: In den letzten 12 Monaten wurde mindestens ein Schritt tatsächlich entfernt oder parallelisiert.",
    ],
  },
  ...
  // ---------------------------------------------------------------- D4
  {
    ...
    scale: [
      ...
      "Zusätzlich Soll-Werte mit Begründung aus dem Geschäftsbedarf (warum dieser Wert und kein anderer).",
    ],
  },
  {
    ...
    scale: [
      ...
      "Ist vs. Soll inklusive Trend; Abweichungen sind kommentiert (Ursachen bekannt).",
    ],
  },
  {
    ...
    evidence: "Benannte Deltas (was funktioniert gut, was schlecht) und benannte Blocker; Abgleich mit Backlog oder Plänen.",
    scale: [
  ...
  },
  {
    ...
    evidence: "Belegtes Mengengerüst: Durchläufe/Jahr aus Systemdaten, beteiligte Rollen × Zeit, Fehler-/Nacharbeitsfälle — Rohstoff für Addressable Value (B §8) und Business Case (Teil 2).",
    scale: [
      ...
      "Volumen, Aufwand und Fehler-/Nacharbeitsquote belegt; daraus ist ein nachvollziehbarer Geldwert je Verbesserungshebel ableitbar.",
    ],
  },
  ...
  // ---------------------------------------------------------------- D5
  {
    ...
    evidence: "Echter Datenauszug mit Timestamps aus mindestens einem beteiligten System, während des Assessments gezogen (Exhaust-Daten zuerst, B §6.1).",
    scale: [
      "Keine Timestamps erhebbar: Der Ablauf läuft mündlich oder auf Papier, und kein beteiligtes System schreibt auswertbare Zeitstempel.",
      "Timestamps nur am Start ODER am Ende des Prozesses, oder nur manuell nacherfassbar.",
  ...
  },
  {
    ...
    evidence: "KPI-Liste mit Datenquelle und Aktualisierungstakt je KPI; Test: der aktuelle Wert wird im Termin abgerufen.",
    scale: [
      "Keine Kennzahl vorhanden.",
      "Kennzahlen benannt; aktueller Wert im Termin nicht abrufbar (muss „zusammengesucht“ werden).",
      "Werte abrufbar; Erhebung manuell (jemand pflegt eine Liste); Takt unregelmäßig.",
      "Werte automatisch erhoben in festem Takt; Definition je KPI schriftlich.",
      "Zusätzlich Historie ≥12 Monate und benannter Empfängerkreis, der die Werte nachweislich erhält.",
    ],
  },
  {
    ...
    evidence: "Mapping vorhandene KPIs ↔ Zielkriterien aus K4.1; schriftlich benannte Messlücken und bekannte Fehlalarme.",
    scale: [
      ...
      "Zusätzlich sind bekannte Lücken und Fehlalarme der KPIs schriftlich dokumentiert — man weiß, was die Zahlen NICHT zeigen.",
    ],
  },
  {
    ...
    scale: [
      ...
      "Ursache per manueller Einzelfallanalyse auffindbar (Vorgänge nachschlagen).",
  ...
  // ---------------------------------------------------------------- D6
  {
    ...
    scale: [
      ...
      "Regelzyklus mit mehreren belegten Änderungen pro Jahr; Wirkung der Änderungen nachgemessen.",
    ],
  },
  {
    ...
    scale: [
      ...
      "Zusätzlich ist für statische Zonen begründet, ob sie stabil-gut oder eingefroren-krank sind (bewusste, dokumentierte Entscheidung).",
    ],
  },
  ...
  // ---------------------------------------------------------------- D7 (per Kernkomponente)
  {
    ...
    evidence: "Versions-/Änderungshistorie der Komponente gegen dokumentierte Mängel und Workarounds (Tickets, Behelfslisten).",
    scale: [
      "Komponente seit Jahren unverändert, obwohl aktive Workarounds um sie herum existieren; niemand traut sich heran.",
      ...
      "Frequenz wird gesteuert: instabile oder kritische Komponenten bekommen bewusst höhere Test- und Iterations-Velocity.",
    ],
  },
  {
    ...
    evidence: "Dokumentierte Konsumentenliste (wer liest, wer schreibt, welche Folgeprozesse); Vorfallhistorie der letzten Änderung. Vorstufe zu B §5 Prüfpunkte 1–3.",
    scale: [
      ...
      "Konsumentenliste dokumentiert und in den letzten 12 Monaten verifiziert (z. B. bei einer Änderung bestätigt).",
      "Kopplungen inklusive Schnittstellenabsprachen dokumentiert (wer bekommt was in welchem Format); Änderungen werden konsumentenweise angekündigt.",
    ],
  },
  {
    ...
    evidence: "Existierende Testkopie/-umgebung, dokumentierter Rückfallpfad (Sicherungsstand, Parallelbetrieb); Nachweis am letzten Änderungsfall.",
    scale: [
      "Änderungen nur am offenen Herzen; kein Sicherungsstand, kein Weg zurück.",
      "Manuelle Sicherungskopie vor Änderungen („_alt“, „_backup“); Rückweg ungetestet.",
      "Testkopie möglich und schon genutzt; Rollback manuell und personenabhängig.",
      "Test- und Rückrollweg dokumentiert und bei der letzten Änderung tatsächlich genutzt.",
  ...
  },
  {
    ...
    scale: [
      "Genau eine Person kann ändern; bei Abwesenheit steht die Komponente still (Fall schon eingetreten).",
      ...
      "≥2 Personen ändern regelmäßig; das Wissen ist dokumentiert, nicht nur im Kopf.",
      "Änderfähigkeit ist Rollenwissen: dokumentiert und mindestens einmal an eine neue Person übergeben worden.",
    ],
  },
  ...
  // ---------------------------------------------------------------- D8
  {
    ...
    evidence: "Benannte Person; Test im Gespräch: beantwortet Detailfragen zum Ablauf UND benennt ihren Entscheidungsrahmen; Gegenprobe bei deren Führungskraft. Entspricht dem Spoke-Minimum (B §7).",
    scale: [
      ...
      "Person kennt den Prozess und entscheidet in definiertem Rahmen; keine reservierte Kapazität für Prozessarbeit (Champion fehlt).",
  ...
  },
  {
    ...
    question: "(an Ausführende, nicht nur den Owner) Beschreib den Gesamtprozess — was passiert vor deinem Schritt, was danach, und wozu?",
    ...
    scale: [
      ...
      "Gesamtablauf grob korrekt; Zweck einzelner Schritte unklar („machen wir für Abteilung X, glaube ich“).",
      "Die Mehrheit beschreibt Ablauf und Zweck korrekt.",
      "Zusätzlich benennen Befragte unabhängig voneinander dieselben Schwachstellen — die Organisation sieht ihren Prozess selbst.",
    ],
  },
  {
    ...
    evidence: "Beobachtete Toolnutzung in der Stichprobe; Verhältnis Selbsthilfe (Filter, Vorlagen, Formeln) zu Stillstand/Ticket; Herkunft vorhandener Hilfsmittel.",
    scale: [
      "Grundfunktionen der beteiligten Tools werden umgangen (Ausdrucken, Abtippen, Zuruf).",
      ...
      "Hilfsmittel werden geteilt und gemeinsam genutzt; die Mehrheit nutzt fortgeschrittene Funktionen.",
      "Das Team passt Tools im erlaubten Rahmen selbst an (Reports, Vorlagen, kleine Automationen) und dokumentiert das.",
    ],
  },
  {
    ...
    evidence: "Befragte definieren den Haupt-KPI korrekt (Zähler, Nenner, Zeitraum) und benennen Signalgrößen; Abgleich mit der tatsächlichen KPI-Definition.",
    scale: [
      ...
      "Zusätzlich benennen Befragte Signalgrößen, die heute NICHT gemessen werden — direkter Input für den Feedback-Loop (D6) und die Coaching-Section KPIs (Teil 2).",
    ],
  },
  {
    ...
    evidence: "Stichprobe im Betrieb: Wird das neue Verfahren genutzt, oder leben Alt-Wege weiter (alte Liste, alter Ablageort, Schatten-Mailverteiler)?",
    scale: [
      ...
      "Adoption wurde gemessen (Nutzungsdaten), Nachzügler aktiv nachgezogen; Abschaltdatum des Alt-Wegs dokumentiert.",
    ],
  },
];
